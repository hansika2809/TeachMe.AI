...
\begin{itemize}
    \item \textbf{Usage:} This model is used exclusively by the \texttt{Text\_Summarizer\_Agent}. By custom-fine-tuning the \textbf{Flan-T5-Base model} on online available dataset (arXiv), the model is able to summarize the daily class lectures notes and pdfs.
